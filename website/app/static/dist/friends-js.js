...
function reqSendPartyInvite(userId){let formData=new FormData();formData.append('user_id',userId);const res=fetch('/friends/send_party_invite',{method:"POST",body:formData})
const result=res.json();console.log(result);}
